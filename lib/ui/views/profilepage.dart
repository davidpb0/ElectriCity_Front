...
class _ProfilePageState extends State<ProfilePage> {
          ...
          return Dismissible(
            ...
            child: Padding(
                ...
                child: RechargePreview(
                    info: StationController().getRechargeStationbyId(item))),
          );
        });
  }
  ...
  Future share(SocialMedia socialPlatform) async {
    ...
    final urlShare = Uri.encodeComponent(
        'https://electricity-download.w3spaces.com/index.html');
    final urls = {
      SocialMedia.twitter:
    ...
    if (!UserController().shared) {
      PrizeController().claimCustomPrize(250);
      UserController().shared = true;
    }
  }
}
